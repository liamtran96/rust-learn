...
7. Create `code/<phase>/<slug>/BRIEF.md` using this structure and fill every field from the source material:
   ...
   ## Spec
   <Relevant exercise prompt from topics/rust/exercises/ch<NN>-*.md>
...
10. Keep each brief section to roughly three lines where practical.
