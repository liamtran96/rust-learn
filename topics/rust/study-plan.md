...
- [x] Read [[02-ownership/ownership|ownership]], [[02-ownership/borrowing|borrowing]], [[02-ownership/slices|slices]] — **only to unblock a drill**, ≤10 min per sitting
...
- [x] Read [[02-ownership/lifetimes|lifetimes]] after drill d08 — read it twice; it doesn't click the first time
- [x] Skim [[cheatsheets/lifetimes-cheatsheet|lifetimes cheatsheet]] daily
